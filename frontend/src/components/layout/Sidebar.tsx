...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Billing', href: '/admin/billing', icon: FileText, roles: ['admin', 'receptionist', 'patient'] },
  { label: 'Lab & Diagnostics', href: '/lab', icon: FlaskConical, roles: ['admin', 'doctor', 'nurse'] },
  { label: 'Prescriptions', href: '/prescriptions', icon: Pill, roles: ['admin', 'doctor', 'nurse', 'patient'] },
